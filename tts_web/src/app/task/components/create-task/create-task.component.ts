    ...
    if (this.currentTaskStatus) {
      ...
      if (
        ...
        if (!this.updateScreen) {
          if (this.task.taskStartDate != undefined ||
            ...
            if (this.task.taskParent == 0 || this.task.taskParent == undefined || this.task.taskParent == null) {
      ...
      if (
        ...
        if (!this.updateScreen) {
          ...
          if (this.parentTask.taskStartDate != undefined ||
            this.parentTask.taskStartDate != null ||
            this.parentTask.taskStartDate) {
            this.task.taskStartDate = this.parentTask.taskStartDate;
            this.task.taskEndDate = this.parentTask.taskEndDate;
            this.todayForPlannedStartDate = new Date(this.parentTask.taskStartDate).toISOString().split('T')[0];
